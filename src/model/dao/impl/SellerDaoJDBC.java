...
public class SellerDaoJDBC implements SellerDao {
	...
	private Seller instantiateSeller(ResultSet rs, Department dep) throws SQLException {
		...
		// seller.setBirthDate(rs.getDate("BirthDate")); /// USA A LIB java.sql.Date
		seller.setBirthDate(new java.util.Date(rs.getTimestamp("BirthDate").getTime())); /// USA A LIB java.util.Date
